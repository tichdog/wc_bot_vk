...
from handlers.command import admin_labeler as start_admin_labeler
from handlers.command import user_labeler as start_user_labeler


def register_all_handlers(bot: Bot):
    register_admin_handlers(bot)
    bot.labeler.load(user_labeler)
    bot.labeler.load(start_admin_labeler)
    bot.labeler.load(start_user_labeler)
